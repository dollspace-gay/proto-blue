...
pub async fn call(
    ...
    let response = match client.query("com.atproto.sync.listReposByCollection", qp.as_ref(), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.query("com.atproto.sync.listReposByCollection", move |ctx| {
