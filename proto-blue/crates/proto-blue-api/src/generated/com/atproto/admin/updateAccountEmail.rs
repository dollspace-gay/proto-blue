...
pub async fn call(
    ...
    let response = match client.procedure("com.atproto.admin.updateAccountEmail", qp_ref, Some(body), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<serde_json::Value, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("com.atproto.admin.updateAccountEmail", move |ctx| {
