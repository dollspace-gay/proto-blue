...
pub async fn call(
    ...
    let response = match client.procedure("com.atproto.server.activateAccount", qp_ref, None, opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<serde_json::Value, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("com.atproto.server.activateAccount", move |ctx| {
