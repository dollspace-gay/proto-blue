...
pub async fn call(
    ...
    let response = match client.procedure("com.atproto.server.createInviteCode", qp_ref, Some(body), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("com.atproto.server.createInviteCode", move |ctx| {
