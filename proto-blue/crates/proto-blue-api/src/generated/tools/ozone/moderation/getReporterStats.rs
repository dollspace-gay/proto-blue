...
pub async fn call(
    ...
    let response = match client.query("tools.ozone.moderation.getReporterStats", qp.as_ref(), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.query("tools.ozone.moderation.getReporterStats", move |ctx| {
