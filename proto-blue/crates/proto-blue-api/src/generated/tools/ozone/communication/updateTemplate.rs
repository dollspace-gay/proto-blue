...
pub async fn call(
    ...
    let response = match client.procedure("tools.ozone.communication.updateTemplate", qp_ref, Some(body), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("tools.ozone.communication.updateTemplate", move |ctx| {
