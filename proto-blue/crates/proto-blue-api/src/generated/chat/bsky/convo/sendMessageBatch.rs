...
pub async fn call(
    ...
    let response = match client.procedure("chat.bsky.convo.sendMessageBatch", qp_ref, Some(body), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("chat.bsky.convo.sendMessageBatch", move |ctx| {
