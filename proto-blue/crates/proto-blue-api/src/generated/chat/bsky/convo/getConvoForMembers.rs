...
pub struct Params {
    pub members: Vec<proto_blue_syntax::Did>,
}
...
pub async fn call(
    ...
    let response = match client
        .query("chat.bsky.convo.getConvoForMembers", qp.as_ref(), opts)
        .await
    {
        Ok(r) => r,
        ...
        + 'static,
{
    ...
    server.query("chat.bsky.convo.getConvoForMembers", move |ctx| {
...
fn params_from_ctx(ctx: &proto_blue_xrpc::HandlerContext) -> Option<Params> {
    ...
    Some(Params {
        members: (ctx.params.get("members").and_then(|v| {
            v.split(',')
