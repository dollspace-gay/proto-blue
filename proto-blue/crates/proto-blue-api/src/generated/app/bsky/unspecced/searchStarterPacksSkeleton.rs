...
pub async fn call(
    ...
    let response = match client.query("app.bsky.unspecced.searchStarterPacksSkeleton", qp.as_ref(), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.query("app.bsky.unspecced.searchStarterPacksSkeleton", move |ctx| {
