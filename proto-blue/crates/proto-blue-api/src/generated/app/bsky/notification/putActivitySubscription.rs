...
pub async fn call(
    ...
    let response = match client.procedure("app.bsky.notification.putActivitySubscription", qp_ref, Some(body), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<Output, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("app.bsky.notification.putActivitySubscription", move |ctx| {
