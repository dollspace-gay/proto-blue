...
pub async fn call(
    ...
    let response = match client.procedure("app.bsky.notification.putPreferences", qp_ref, Some(body), opts).await {
        Ok(r) => r,
    ...
    Fut: std::future::Future<Output = Result<serde_json::Value, proto_blue_xrpc::XrpcServerError>> + Send + 'static,
{
    ...
    server.procedure("app.bsky.notification.putPreferences", move |ctx| {
